...
class FavoriteModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        product_insertion = Product.objects.create(name='Compote de pomme', url='http://helloworld2.com',
                                                   image_url='http://helloworld.com/image2', nutriscore='a',
                                                   fat_100g=0.1,
                                                   satured_fat_100g=0.4, salt_100g=0.1, sugar_100g=0.3)
        product_insertion.categories.add(Category.objects.create(name='Compote'))
        Favorite.objects.create(product_to_substitute=Product.objects.get(id=1),
                                product_to_substitute_id=Product.objects.get(id=2))
